...
public class HawkConfig {
    ...
    public static final String API_STORE_LIST = "api_store_list";
    public static final String API_INDEX_URL = "api_index_url";
    public static final String API_LINE_NAME = "api_line_name";
    ...
    public static final String CONFIG_CACHE_DAYS = "config_cache_days";
    public static final String WINDOW_PREVIEW = "window_preview";
